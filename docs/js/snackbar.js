...
baselineSnackbarBtn.addEventListener("click", () =>
  showSnackbar(baselineSnackbar)
);
leadingSnackbarBtn.addEventListener("click", () =>
  showSnackbar(leadingSnackbar)
);
trailingSnackbarBtn.addEventListener("click", () =>
  showSnackbar(trailingSnackbar)
);
